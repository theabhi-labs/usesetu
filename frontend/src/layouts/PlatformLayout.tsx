...
export const PlatformLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-bg text-text-primary flex flex-col selection:bg-accent selection:text-white">
      ...
      <header className="sticky top-0 z-40 bg-surface/90 backdrop-blur-xl border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-4 sm:space-x-6">
            <Link to="/platform" className="flex items-center space-x-3 group shrink-0">
              <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-accent to-accent-hover flex items-center justify-center shadow-lg shadow-accent/20 group-hover:scale-105 transition-transform duration-200">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="hidden sm:flex items-center space-x-3 pl-3 border-l border-border">
              <Link to="/platform/account" className="flex items-center space-x-2.5 hover:opacity-80 transition-opacity">
                <div className="w-8 h-8 rounded-xl bg-surface-elevated border border-border flex items-center justify-center text-accent font-black text-xs shadow-xs">
                ...
                <div className="flex flex-col text-left">
                  ...
                  <span className="text-[10px] text-text-tertiary truncate max-w-[120px]">{user?.email}</span>
                </div>
              </Link>
              ...
              <button
                ...
                className="p-1.5 text-text-tertiary hover:text-error hover:bg-error/10 rounded-lg transition-colors cursor-pointer"
              >
            ...
            <button
              ...
              className="md:hidden p-2 rounded-xl text-text-secondary hover:text-text-primary hover:bg-surface-elevated transition-colors cursor-pointer"
            >
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-border bg-surface p-4 space-y-4 animate-in slide-in-from-top-2 duration-150">
              ...
              {navLinks.map((link) => {
                ...
                return (
                  ...
                  >
                    ...
                    {link.badge && (
                      <span className="text-[10px] bg-surface-elevated text-accent px-2 py-0.5 rounded-full font-black">
                        {link.badge}
                      </span>
                    )}
                  </Link>
            ...
            <div className="pt-3 border-t border-border flex items-center justify-between">
              ...
              <button
                onClick={handleLogout}
                className="text-xs font-semibold text-error hover:opacity-80 flex items-center space-x-1 cursor-pointer"
              >
      ...
      <div className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col md:flex-row gap-8">
        ...
        <aside className="hidden md:block w-60 shrink-0 space-y-6">
          <div className="bg-surface border border-border rounded-3xl p-3 shadow-xs space-y-1">
            <div className="px-3 py-2 text-[10px] font-black uppercase tracking-wider text-text-tertiary">
              ...
              {navLinks.map((link) => {
                ...
                return (
                  ...
                  >
                    ...
                    {link.badge ? (
                      <span className="text-[10px] bg-accent text-white px-2 py-0.2 rounded-full font-black">
                        {link.badge}
                      </span>
                    ) : (
          ...
          {/* Quick Help Card */}
          <div className="bg-surface border border-border rounded-3xl p-4 text-xs space-y-2">
      ...
      <footer className="border-t border-border bg-surface py-6 mt-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between text-xs text-text-secondary gap-4">
